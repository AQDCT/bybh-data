...
class QuestionController extends Controller
{
    ...
    /**
     * Display one question - print-friendly
     *
     * @Route("/print/question/{id}/{g1}/{g2}/{g3}/{g4}", name="printsinglequestion")
     * @Method("GET")
     * @Template()
     */
    public function getPrintSingleQuestionAction($id, $g1='USA', $g2=NULL, $g3=NULL, $g4=NULL)
    {
        $em = $this->getDoctrine()->getManager();
        $thisQuestion = $em->getRepository('CDCChartBundle:Question')->findOneById($id);
        ...
        return $this->render('CDCChartBundle:Question:print.question.html.twig', array('question' => $thisQuestion, 'firstCategory' => $firstCategory, 'selections' => $selections, 'questions' => $questions, 'max' => $max, 'min' => $min, 'step' => $step, 'g1' => $g1, 'g1row' => $g1row, 'g2' => $g2, 'g2row' => $g2row, 'g3row' => $g3row, 'g4row' => $g4row, 'dataset' => $dataset, 'form' => $form->createView()));
    }
